...
export class TokenContract extends ContractBase {
  ...
  public declare methods: {
    ...
    balance_of_private: ((owner: AztecAddressLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">

    /** balance_of_public(owner: struct) */
    balance_of_public: ((owner: AztecAddressLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">
    ...
    transfer: ((to: AztecAddressLike, amount: bigint | number) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">
    ...
    /** transfer_in_private_to_partial_note(from: struct, partial_note: struct, amount: integer, nonce: field) */
    transfer_in_private_to_partial_note: ((
      from: AztecAddressLike,
      partial_note: { commitment: FieldLike },
      amount: bigint | number,
      nonce: FieldLike,
    ...
    /** transfer_to_public_and_prepare_refund(from: struct, to: struct, amount: integer, nonce: field) */
    transfer_to_public_and_prepare_refund: ((
      from: AztecAddressLike,
      to: AztecAddressLike,
      amount: bigint | number,
      nonce: FieldLike,
    ...
    /** un_balance_of_public(owner: struct) */
    un_balance_of_public: ((owner: AztecAddressLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">
  ...
  public static get events(): {
    Transfer: { abiType: AbiType; eventSelector: EventSelector; fieldNames: string[] }
  } {
    return {
      Transfer: {
        abiType: {
